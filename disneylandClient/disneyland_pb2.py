...
_DISNEYLAND = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='CreateMultipeJobs',
    full_name='Disneyland.CreateMultipeJobs',
    index=1,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='DeleteJob',
    full_name='Disneyland.DeleteJob',
    index=6,
    containing_service=None,
    input_type=_REQUESTWITHID,
    output_type=_JOB,
